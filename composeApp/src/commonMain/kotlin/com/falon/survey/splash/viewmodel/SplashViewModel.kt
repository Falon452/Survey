package com.falon.survey.splash.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import androidx.navigation.NavController
import com.falon.survey.Routes
import com.falon.survey.splash.effect.SplashEffect
...
class SplashViewModel: ViewModel() {
    ...
    fun onEffect(
        ...
        when (effect) {
            ...
            SplashEffect.RouteToHabits -> navController.navigate(Routes.SurveyScreen) {
                popUpTo(Routes.SplashScreen) { inclusive = true }
            }
        }
    }
